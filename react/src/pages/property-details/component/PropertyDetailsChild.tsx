...
import { faDollarSign, faHeart, faSwimmer } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="px-24 ">
          <div className="">
            <div className="flex items-center">
              <p className="text-md "> 
              <FontAwesomeIcon icon={faDollarSign} size="sm" className="text-red"/>{" "}
              {property.price}
               </p>
            </div>
            ...
            <div>
              <p className="line-clamp-1 text-gray-800 text-md">
                <FontAwesomeIcon icon={faLocationDot} size="sm" className="text-red"/>{" "}
                {property.address}
              </p>
            </div>
            ...
            <div className="justify-center">
              <div className="flex space-x-3 overflow-hidden rounded-lg px-1 py-1 gap-12">
                ...
                <p className="flex items-center font-medium ">
                  <FontAwesomeIcon
                    icon={faBath}
                    className="mr-2 text-blue-900 text-red"
                  />
                  {property.bathrooms}
                </p>
                <p className="flex items-center font-medium text-gray-800">
...
<div className="flex px-24 mb-24 text-red">
<button onClick={openPopupC}>
      ...
      <div className="flex">
        <div className="flex w-full items-center pl-28 gap-6 p-8">
          <button onClick={openPopupB} className="bg-red py-2.5 px-8 rounded-lg text-white hover:shadow-lg">
          ...
          <button onClick={openPopupA} className="border-2 py-2 px-12 rounded-lg text-red hover:shadow-lg">
            Enquire Now
          </button>
      ...
      <div className="flex w-full items-center justify-center p-8 mb-12">
        ...
        className="bg-red py-2.5 px-8 rounded-lg text-white hover:shadow-lg">
          Book to view the property
        </button>
