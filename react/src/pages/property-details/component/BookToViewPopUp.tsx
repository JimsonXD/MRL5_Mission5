...
function BookToViewPopUp(props: BookToViewPopUpProps) {
  ...
  const [bookingConfirmedVisible, setBookingConfirmedVisible] =
  ...
  const addToPlanner = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        // Booking was successful, you can handle the confirmation here        setBookingConfirmedVisible(true);
      } else {
          ...
          <form className="w-full bg-platinum p-8">
            ...
            <div className="md:flex md:items-center">
              <div className="flex justify-center gap-4 md:w-1/3 pt-8">
                  <button
                    className="shadow btn-outline hover:bg-teal-400 focus:shadow-outline focus:outline-none text-red bg-white font-bold py-2 px-4 rounded border-1"
                    type="button"
