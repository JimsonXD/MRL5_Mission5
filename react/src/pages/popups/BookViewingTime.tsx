...
import CalendarBookViewingTime from '../popups/Calendar'
const BookViewingTime = () => {
  return (
    ...
    <div className="space-y-12">
      ...
      <div className="border-b border-gray-900/10 pb-12">
        <h2 className="text-base font-semibold leading-7 text-gray-900">Book Viewing Time</h2>
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="sm:col-span-3">
            ...
            <button className={styling.BookViewingTimeBookButton}>Book</button>
            </div>

           <div className={styling.CalendarBookViewingTime}>
            <CalendarBookViewingTime/>
            </div>
